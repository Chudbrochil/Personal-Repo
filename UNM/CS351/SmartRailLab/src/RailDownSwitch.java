 ...
 * Anna Carey
 *
 * This switch has two neighbors on the left and one neighbor on the right. It is drawn to go DOWN and straight across.
 *
 * To use this class, you MUST call setNeighbors with all three parameters OR setNeighbors with two parameters
 *   and setDownNeighbor to set its neighbor.
 *   leftDownNeighbor must be a switch.
 */
public class RailDownSwitch extends Thread implements IMessagable, IDrawable
{
