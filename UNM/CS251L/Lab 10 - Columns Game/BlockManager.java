 ...
 * CS 251 - Lab 10 Columns Game Model
 * 
...
public class BlockManager {
     ...
     */
    public BlockManager(int rows, int cols, int blockTypes) {
        this.gameRows = rows;
        this.gameCols = cols;
    ...
    // Constructor for use with BlockManagerTest
    ...
    /**
     * Return game board for use in painting the pieces and some very
     * light logic for comparing if a given block is "blank"
     * @return The whole character array holding the position of the
     *         1x1 pieces on the board. 
     */
