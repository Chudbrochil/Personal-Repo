...
namespace Csharp_GalczakP2
{
    class TestComputerOrder
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Anthony Galczak\nProgram 2\nThis program will help you spec out a computer.\n\n");
            ...
            do
            {
                ...
                // Assigning menu gets
                driveOutput = comp.GetDriveMenu();
                moboOutput = comp.GetMboardMenu();
                memoryOutput = comp.GetMemoryMenu();
                periphOutput = comp.GetPeripheralsMenu();
                ...
                comp.SetDriveOptionIndex(driveChoice);
                ...
                comp.SetMBoardOptionIndex(moboChoice);
                ...
                comp.SetMemoryOptionIndex(memoryChoice);
                ...
                do
                {
                    ...
                    Console.WriteLine(periphOutput + "\nPlease enter your number for a peripheral, choose however many you wants.\n"
                ...
                comp.SetPeriphList(tempPeriphList);

                // Printing an order summary to the user
                summary = comp.GetOrderSummary();
