...
public class Hangman
{
	...
	private String name; // static so it persists between hangman games
...
// 1 is letter has been guessed already, 2 is correct, 3 is missed letter, 4 is loss/win
	...
	public int getAttemptsRemaining(){
		// Calculating the remaining attempts for the user (This is changed to a fixed 10)
		attemptsRemain = (10 - missedLetters.length());
